...
# src/mod/applications/mod_skel/Makefile.  Generated from Makefile.in by configure.
...
subdir = src/mod/applications/mod_skel
...
mod_skel_la_DEPENDENCIES = $(switch_builddir)/libfreeswitch.la
am_mod_skel_la_OBJECTS = mod_skel_la-mod_skel.lo
mod_skel_la_OBJECTS = $(am_mod_skel_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
am__v_lt_1 =
mod_skel_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(mod_skel_la_CFLAGS) \
	$(CFLAGS) $(mod_skel_la_LDFLAGS) $(LDFLAGS) -o $@
AM_V_P = $(am__v_P_$(V))
...
am__v_CCLD_1 =
SOURCES = $(mod_skel_la_SOURCES)
DIST_SOURCES = $(mod_skel_la_SOURCES)
...
ACLOCAL = ${SHELL} /usr/src/freeswitch/build/config/missing aclocal-1.13
AMQP_CFLAGS =
AMQP_LIBS =
AMRWB_CFLAGS =
AMRWB_LIBS =
...
AUTOMAKE = ${SHELL} /usr/src/freeswitch/build/config/missing automake-1.13
...
EGREP = /bin/grep -E
ERLANG = /bin/erl
ERLANG_CFLAGS = -I/usr/lib64/erlang/lib/erl_interface-3.7.15/include
ERLANG_LDFLAGS = -L/usr/lib64/erlang/lib/erl_interface-3.7.15/lib  -lei
ERLANG_MAJOR = 5
ERLANG_MINOR = 10
ERLANG_VERSION = 5.10.4
ESL_LDFLAGS =
EXEEXT =
FGREP = /bin/grep -F
FLITE_CFLAGS =
...
G7221_CFLAGS =
G7221_LIBS =
GETG729 = cd /usr/src/freeswitch/libs && /bin/sh /usr/src/freeswitch/build/getg729.sh
...
STIRSHAKEN_LIBS =
STRIP = strip
SWITCH_AM_CFLAGS = -I/usr/include/uuid   -I/usr/src/freeswitch/src/include -I/usr/src/freeswitch/src/include -I/usr/src/freeswitch/libs/libteletone/src -fPIC -ffast-math -Werror -Wno-unused-result -fvisibility=hidden -DSWITCH_API_VISIBILITY=1 -DCJSON_API_VISIBILITY=1 -DHAVE_VISIBILITY=1 -g -ggdb -DENABLE_ZRTP -DHAVE_OPENSSL
...
YAML_LIBS =
ZCAT = /bin/gunzip
abs_builddir = /usr/src/freeswitch/src/mod/applications/mod_skel
abs_srcdir = /usr/src/freeswitch/src/mod/applications/mod_skel
...
subdirs =  libs/srtp libs/apr libs/apr-util libs/iksemel libs/libdingaling libs/unimrcp libs/libzrtp
...
$(srcdir)/Makefile.in:  $(srcdir)/Makefile.am $(top_srcdir)/build/modmake.rulesam $(am__configure_deps)
	...
	echo ' cd $(top_srcdir) && $(AUTOMAKE) --foreign src/mod/applications/mod_skel/Makefile'; \
	$(am__cd) $(top_srcdir) && \
	  $(AUTOMAKE) --foreign src/mod/applications/mod_skel/Makefile
.PRECIOUS: Makefile
...
mod_skel.la: $(mod_skel_la_OBJECTS) $(mod_skel_la_DEPENDENCIES) $(EXTRA_mod_skel_la_DEPENDENCIES)
	$(AM_V_CCLD)$(mod_skel_la_LINK) -rpath $(moddir) $(mod_skel_la_OBJECTS) $(mod_skel_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/mod_skel_la-mod_skel.Plo
...
mod_skel_la-mod_skel.lo: mod_skel.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_skel_la_CFLAGS) $(CFLAGS) -MT mod_skel_la-mod_skel.lo -MD -MP -MF $(DEPDIR)/mod_skel_la-mod_skel.Tpo -c -o mod_skel_la-mod_skel.lo `test -f 'mod_skel.c' || echo '$(srcdir)/'`mod_skel.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/mod_skel_la-mod_skel.Tpo $(DEPDIR)/mod_skel_la-mod_skel.Plo
#	$(AM_V_CC)source='mod_skel.c' object='mod_skel_la-mod_skel.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mod_skel_la_CFLAGS) $(CFLAGS) -c -o mod_skel_la-mod_skel.lo `test -f 'mod_skel.c' || echo '$(srcdir)/'`mod_skel.c
